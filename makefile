...
HASHLIB_8xv: hashlib.asm
	$(call MKDIR,$(@D))
	fasmg hashlib.asm HASHLIB.8xv

#make install
install: HASHLIB_8xv HASHLIB.lib
	$(CP) $(call NATIVEPATH,hashlib.h) $(call NATIVEPATH,$(CEDEV)/include)
	$(CP) $(call NATIVEPATH,HASHLIB.lib) $(call NATIVEPATH,$(CEDEV)/lib/libload/hashlib.lib)
